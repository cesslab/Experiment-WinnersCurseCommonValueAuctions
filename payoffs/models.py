...
class Player(BasePlayer):
    ...
    method_1_indifferent_random = models.FloatField()
    ...
    method_1_bid = models.FloatField()
    method_1_other_bid = models.FloatField()
    method_1_win_lottery = models.BooleanField()
    method_1_low_chosen = models.BooleanField()
    method_1_high_chosen = models.BooleanField()
    method_1_low_value = models.FloatField()
    method_1_high_value = models.FloatField()
    method_1_low_prob = models.FloatField()
    method_1_high_prob = models.FloatField()
    method_1_signal = models.FloatField()
    method_1_others_signal = models.FloatField()
    method_1_realized_value = models.FloatField()
    method_1_earnings = models.FloatField()

    method_2_player_id = models.IntegerField()
    method_2_other_player_id = models.IntegerField()
    method_2_auction = models.IntegerField()
    method_2_price = models.FloatField()
    method_2_random_price = models.FloatField()
    method_2_price_accepted = models.BooleanField()
    method_2_bid = models.FloatField()
    method_2_other_bid = models.FloatField()
    method_2_win_lottery = models.BooleanField()
    method_2_low_chosen = models.BooleanField()
    method_2_high_chosen = models.BooleanField()
    method_2_low_value = models.FloatField()
    method_2_high_value = models.FloatField()
    method_2_low_prob = models.FloatField()
    method_2_high_prob = models.FloatField()
    method_2_signal = models.FloatField()
    method_2_others_signal = models.FloatField()
    method_2_realized_value = models.FloatField()
    method_2_earnings = models.FloatField()
    ...
    def save_results(self, method_1: MethodOneResults, method_2: MethodTwoResults, method_3: MethodThreeResults):
        ...
        self.method_3_cutoff = method_3.cutoff
