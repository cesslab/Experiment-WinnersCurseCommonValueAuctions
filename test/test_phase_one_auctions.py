...
def test_auction_collection_contain_auctions():
    phase_one_auctions = AuctionFactory.phase_one_auction_collection()
...
def test_rounds_equal_num_auction_pairs():
    phase_one_auctions = AuctionFactory.phase_one_auction_collection()
    assert AuctionFactory.phase_one_rounds() == len(phase_one_auctions.left_auctions)
    assert AuctionFactory.phase_one_rounds() == len(phase_one_auctions.right_auctions)


def test_left_auctions_not_empty():
    assert AuctionFactory.phase_one_auction_collection().left_auctions


def test_right_auctions_not_empty():
    assert AuctionFactory.phase_one_auction_collection().right_auctions
...
def test_left_auctions_have_valid_type_ids():
    phase_one_auction = AuctionFactory.phase_one_auction_collection()
